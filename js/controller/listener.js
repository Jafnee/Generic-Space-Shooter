define(["controller/action", "model/canvas"], function (Action, Canvas) {
	...
	Canvas.canvas.addEventListener("mousedown", function(){Action.mouseClicked(true);}, false);
	Canvas.canvas.addEventListener("mouseup", function(){Action.mouseClicked(false);}, false);
